...
static char selfgcolor[]            = "#181926"; /* crust */
static char selbordercolor[]        = "#b7bdf8"; /* lavender */
static char selbgcolor[]            = "#c6a0f6"; /* mauve */
...
static const Rule rules[] = {
	...
	{ "DBeaver",                   "DBeaver",								NULL,					1	<< 3,				0,							0,						-1 },
	{ "Postman",                   "postman",								NULL,					1	<< 3,				0,							0,						-1 },
...
static Key keys[] = {
	...
	// { MODKEY,                        XK_e,      spawn,          SHCMD("/home/ad/.config/bspwm/scripts/clip.sh")},
  ...
  { MODKEY,                        XK_c,      spawn,          SHCMD("/home/ad/.config/bspwm/scripts/colorpicker") },
	...
	{ MODKEY|Mod1Mask,               XK_a,      spawn,          SHCMD("alacritty") },
	{ MODKEY|Mod1Mask,               XK_s,      spawn,          SHCMD("alacritty --class FloaTerm,Alacritty -o window.dimensions.lines=22 window.dimensions.columns=90") },
	...
	{ MODKEY|ShiftMask,              XK_o,      spawn,          SHCMD("/home/ad/.local/bin/flameshot_ocr") },
	...
	{ MODKEY|ShiftMask,              XK_s,      spawn,          SHCMD("st -t 'st~' -g 110x25") },

	{ MODKEY|ShiftMask,              XK_r,      spawn,          SHCMD("/home/ad/.local/bin/screencast" )},
	{ MODKEY|ShiftMask,              XK_m,      spawn,          SHCMD("/usr/bin/simplescreenrecorder" )},
...
// 
	...
	{ 0,            XF86XK_AudioRaiseVolume,       	spawn,          SHCMD("/home/ad/.config/bspwm/scripts/Volume --inc" )},
	{ 0,            XF86XK_AudioLowerVolume,       	spawn,          SHCMD("/home/ad/.config/bspwm/scripts/Volume --dec" )},
